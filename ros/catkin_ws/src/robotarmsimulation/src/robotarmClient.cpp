...
int main(int argc, char** argv)
{
  ...
  if(ros::ok())
  {
    ...
    // ros::spinOnce();
    // sleep(5);
    msg.data = "#0P1500#1P1500#2P1500#3P1500#4P1500#5P1500T3000\n";
    ROS_INFO("sending command : %s", msg.data.c_str());
    lRobotarmCommandPublisher.publish(msg);
    ros::spinOnce();
    sleep(4);
    msg.data = "#0P1500#1P1200#2P1350#3P1600#4P1500#5P500T3000\n";
    ROS_INFO("sending command : %s", msg.data.c_str());
    lRobotarmCommandPublisher.publish(msg);
    ros::spinOnce();
    sleep(4);
    ...
    ros::spinOnce();
    sleep(4);
    msg.data = "#0P1500#1P1500#2P1500#3P1500#4P1500#5P500T1000\n";
    ROS_INFO("sending command : %s", msg.data.c_str());
    lRobotarmCommandPublisher.publish(msg);
    ros::spinOnce();
    sleep(2);
